SURFSUP_WELCOME_MSG = (
    "Welcome to SurfsUp_Bot, I am here to help connect YOU to surf "
    + "spots that fit YOUR surfing. To get started send me the "
    + "message '/setup', if you need any help text me '/help'"
)

SURFSUP_USAGE_MSG = (
    "Commands -- start with '/' and are one word. List of currently implemented:"
...
SURFSUP_BIO_MSG = (
    "The name's Kenton. I'm an ocean lover. My primary activity of choice"
